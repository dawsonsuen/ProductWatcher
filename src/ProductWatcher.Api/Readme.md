...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Aws.ServerlessApi*):

Restore dependencies
```
    cd "Aws.ServerlessApi"
    dotnet restore
```

Execute unit tests
```
    cd "Aws.ServerlessApi/test/Aws.ServerlessApi.Tests"
    dotnet test
```

Deploy application
```
    cd "Aws.ServerlessApi/src/Aws.ServerlessApi"
